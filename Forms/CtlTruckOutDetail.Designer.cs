...
{
    partial class CtlTruckOutDetail
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            this.lblOutRegNo = new System.Windows.Forms.Label();
            ...
            this.label11.Text = "Out Check Time :";
            // 
            // lblCargoType
            // 
            ...
            this.panel1.Size = new System.Drawing.Size(610, 772);
        ...
        {
            lblCardNo.Text = outData.CardNo;
            lblOutRegNo.Text = outData.OutRegNo.ToString();
            lblTruck.Text = outData.TrailerVehicleRegNo;
            lblTruckType.Text = outData.TruckType;
            lblTrailer.Text = outData.TrailerVehicleRegNo;
            lblDriver.Text = outData.DriverName;
            lblLicenseNo.Text = outData.DriverLicenseNo;
            lblContactNo.Text = outData.DriverContactNo;
            lblCargoInfo.Text = outData.OutCargoInfo;
            lblCargoType.Text = outData.OutCargoType;
            lblDateTime.Text = outData.OutCheckDateTime?.ToString("dd/MM/yyyy hh:mm:ss tt");
        }
        #endregion
        ...
        private System.Windows.Forms.Label lblOutRegNo;
