...
namespace TMS_Gate
{
    ...
    public class CHCNetSDK
    {
        ...
        public const int MAX_LEN_XML = 10 * 1024 * 1024;
        ...
        public const int MAX_THERMOMETRY_REGION_NUM = 40;
        public const int MAX_THERMOMETRY_DIFFCOMPARISON_NUM = 40;
        public const int NET_SDK_MAX_THERMOMETRYALGNAME = 128;
        public const int NET_SDK_MAX_SHIPSALGNAME = 128;
        public const int NET_SDK_MAX_FIRESALGNAME = 128;
...
*/
        ...
        **********************************************************/
        ...
        public const int UPLOAD_THERMOMETRIC_FILE = 22; 
        public const int UPLOAD_AI_ALGORITHM_MODEL = 52; 
        public const int UPLOAD_FD_DATA = 35;
        public const int UPLOAD_FACE_DATA = 36;
        ...
        public const int NET_SDK_DOWNLOAD_THERMOMETRIC_FILE = 15; 
        ...
        public struct NET_VCA_FACESNAPCFG
        {
            ...
            public UInt32 dwValidFaceTime; 
            public UInt32 dwUploadInterval;
            public UInt32 dwFaceFilteringTime;
            public byte bySceneID;   
            public byte byInvalCapFilterEnable;
            public byte byInvalCapFilterThreshold;
        ...
        public static void AddLog(int iDeviceIndex, int iLogType, string strFormat)
        {
            ...
            string g_deviceTree = Properties.Settings.Default.device_ip;
            ...
            {
                if (null == g_deviceTree || null == g_deviceTree)
                {
                    strDevInfo = null;
                }
                else
                {
                    strDevInfo = string.Format("{0}-{1}", g_deviceTree, g_deviceTree);
                }
            }
